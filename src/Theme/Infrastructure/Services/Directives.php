...
return [
    ...
    'template' => function ($expression): string {
        ...
        return sprintf('<?php if ($__env->exists(\'%s\')) { echo $__env->make(\'%s\', %s, '.Arr::class.'::except(get_defined_vars(), [\'__data\', \'__path\']))->render(); } else { echo $__env->make(\'%s\', %s, '.Arr::class."::except(get_defined_vars(), ['__data', '__path']))->render(); } ?>", $path, $path, $data, $args[0], $data);
    },
