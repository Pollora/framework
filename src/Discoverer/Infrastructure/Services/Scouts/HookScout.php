...
/**
 * Scout for discovering hooks.
 */
final class HookScout extends SpatieDiscoveryAdapter
{
    /**
     ...
     * @param  array<string>  $directories  Directories to scan for hooks
     */
    ...
    /**
     * Get default directories for hook discovery.
