...
class Bootstrap
{
    ...
    public function __construct(?ConsoleDetectionService $consoleDetectionService, protected DebugDetectorInterface $debugDetector, protected \Pollora\Hook\Domain\Contracts\Action $action)
    {
