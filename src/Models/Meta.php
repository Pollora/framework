...
use Pollen\Exceptions\UnsatisfiedDependencyException;
...
class Meta extends Model
{
    ...
    public static function acf($page = null, $name = null, $format = true)
    {
        ...
        $value = Filter::add('acf/load_value', $value, $page, $field);
        $value = Filter::add('acf/load_value/type='.$field['type'], $value, $page, $field);
        $value = Filter::add('acf/load_value/name='.$field['_name'], $value, $page, $field);
        $value = Filter::add('acf/load_value/key='.$field['key'], $value, $page, $field);
