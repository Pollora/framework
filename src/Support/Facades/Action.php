 ...
 * @method static \Pollora\Hook\Domain\Contracts\HookInterface add(string|array $hooks, \Closure|string|array $callback, int $priority = 10, int $accepted_args = 3) Add an action hook
 * @method static bool exists(string $hook) Check if an action exists
 * @method static \Pollora\Hook\Domain\Contracts\HookInterface|false remove(string $hook, \Closure|string $callback, int $priority = 10) Remove an action hook
 *
