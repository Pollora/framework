...
describe('Asset domain model', function () {
    it('can be instantiated with name, path, and attributes', function () {
        $asset = new \Pollora\Asset\Domain\Models\Asset('main', 'assets/main.js', ['type' => 'js']);
...
describe('AssetFile domain model', function () {
    it('can be instantiated and return filename and container', function () {
        $file = new \Pollora\Asset\Domain\Models\AssetFile('assets/app.css');
    ...
    it('can set a custom asset container', function () {
        $file = (new \Pollora\Asset\Domain\Models\AssetFile('assets/app.css'))->from('custom');
...
describe('ViteManager domain stub', function () {
    ...
    it('returns stub values for all interface methods', function () {
        $vite = new \Pollora\Asset\Domain\Models\ViteManager();
        expect($vite->container())->toBeInstanceOf(\Pollora\Asset\Infrastructure\Repositories\AssetContainer::class);
