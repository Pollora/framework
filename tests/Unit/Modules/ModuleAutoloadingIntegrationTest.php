...
beforeEach(function (): void {
    ...
    $this->app->singleton(fn ($app): ThemeAutoloader => new ThemeAutoloader($app));
});
...
it('can create and use module autoloader', function (): void {
...
it('can create and use theme autoloader', function (): void {
...
it('integrates autoloader with theme module registration', function (): void {
