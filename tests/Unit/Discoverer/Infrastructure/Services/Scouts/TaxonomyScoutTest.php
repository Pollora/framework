...
test('getType returns taxonomy type', function () {
    expect($this->scout->getType())->toBe('taxonomy');
});
...
test('criteria applies AbstractTaxonomy class filter', function () {
