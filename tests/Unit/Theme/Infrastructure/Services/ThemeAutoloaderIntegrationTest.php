...
it('can register multiple themes without conflicts', function () {
    ...
    $theme1 = new class($theme1Path) extends ThemeModule {
        ...
        public function getStudlyName(): string { return 'ThemeOne'; }
        public function getPath(): string { return $this->path . '/theme-one'; }
    };
    ...
    $theme2 = new class($theme2Path) extends ThemeModule {
        ...
        public function getStudlyName(): string { return 'ThemeTwo'; }
        public function getPath(): string { return $this->path . '/theme-two'; }
    };
...
it('can register themes using batch method', function () {
    ...
    $theme1 = new class($batch1Path) extends ThemeModule {
        ...
        public function getStudlyName(): string { return 'BatchTheme1'; }
        public function getPath(): string { return $this->path . '/batch-theme-1'; }
    };
    ...
    $theme2 = new class($batch2Path) extends ThemeModule {
        ...
        public function getStudlyName(): string { return 'BatchTheme2'; }
        public function getPath(): string { return $this->path . '/batch-theme-2'; }
    };
